...
const Days = () => {
	return (
		<div className={'pb-[10%]  text-black w-full h-full mt-16'}>
			<div className={''}>
				<div>
					<div className={'max-md:px-[50px] md:px-[25%] pb-16'}>
						<div className={'max-md:text-xl text-2xl space-y-8'}>
							<p className={'text-2xl bg-[#e73904] font-bold text-white w-[200px] py-3 rounded-md mx-auto text-center italic mb-10'}>BONUS
								#1</p>
							...
							<p className={'w-full max-md:text-start m-0'}> Ushbu kanalga:</p>
							<p className={'w-full max-md:text-start'}>• Qurilishga oid yangiliklar </p>
							<p className={'w-full max-md:text-start'}>• Maslahatlar </p>
							<p className={'w-full max-md:text-start'}>• Va endi katlavan paytidagi ishonchli
				...
				<div>
					...
					<div className={'max-md:px-[50px] md:px-[25%] pb-16'}>
						...
						<div className={'max-md:text-xl text-2xl space-y-10'}>
							<p className={'text-2xl bg-[#e73904] text-white w-[200px] rounded-md font-bold py-3 mx-auto text-center italic mb-10'}>BONUS
								# 2
							</p>
							...
							<p className={' leading-[2] max-md:text-start'}>Sizni istalgan savollaringizga javob berib
								turadigan support
								xizmatimiz bo’ladi.
							</p>
						</div>
				...
				<div>
					<div className={'pb-16 bg-[#e73904]  text-white py-16 max-md:px-[50px] md:px-[25%]'}>
						<div className={'max-md:text-xl text-2xl space-y-5'}>
							...
							<p className={'w-full max-md:text-start'}> U yerda siz o’z ishini
				...
				<div className={'pb-16'}>
					<div className={''}>
						<div className={'max-md:text-xl text-2xl space-y-8 bg-[#e73904] text-white py-16 max-md:px-[50px] md:px-[25%]'}>
							...
							<p className={'w-full  max-md:text-xl text-2xl max-md:text-start'}> Yopiq telegram kanalimizda ishonchli
								...
								boramiz.</p>
							<p className={'w-full max-md:text-xl text-2xl  max-md:text-start'}> Agar siz bizni nomimiz orqali ushbu
								kompaniyalardan uy
								xarid qiladigan bo’lsangiz, </p>
							<p className={'w-full max-md:text-xl text-2xl  max-md:text-start'}> 1% chegirmani ham qo’lga
								kiritasiz. </p>
						</div>
					</div>
				</div>
				...
				<div>
					<div className={''}>
						<div className={'max-md:text-xl text-2xl pb-16 space-y-8 max-md:px-[50px] md:px-[25%]'}>
							<p className={' bg-[#e73904] text-white w-[200px] font-bold py-3 rounded-md mx-auto text-center italic mb-10'}>BONUS
								#5</p>
							...
							<p className={'w-full  max-md:text-start'}> Har oyda bir marta qurilishga oid
								kuchli spikerlarni
								chaqiramiz, ma’lumotlar
								olamiz </p>
							<p className={'w-full  max-md:text-start'}> Va ushbu ma’lumotlarni yopiq telegram
								kanalga yuklab
								boramiz. </p>
							<p className={'w-full   max-md:text-start'}> Spikerlardan qanday qilib
				...
				<div>
					<div className={''}>
						<div className={'max-md:text-xl text-2xl space-y-8 max-md:px-[50px] md:px-[25%]'}>
							...
							<p className={'w-full  max-md:text-start'}> Darslarimizni ko’rganingizdan so’ng,
								bemalol ishonchli
								uylar ro’yxatini tuzib olib,
								o’zingiz xarid qilishingiz mumkin.</p>
							<p className={'w-full  max-md:text-start'}> Yokida buni bizga ham topshirishingiz
								mumkin. </p>
							<p className={'w-full  max-md:text-start'}> Biz sizga o’zimiz hammasini ko’rib
								beramiz.</p>
							<p className={'w-full  max-md:text-start'}> Bu xizmatimiz uchun qo’shimcha
								to’lovlar mavjud.</p>
							<p className={'w-full  max-md:text-start'}> Darslarni xarid qilib, telegram
								guruhga qo’shiladigan
								bo’lsangiz, biz har oy 5ta
								ixtiyor kishini tanlab olamiz </p>
							<p className={'w-full  max-md:text-start'}> Va ularga uyni ko’rib berish
								xizmatimizni bepulga
								taqdim etamiz. </p>
							<p className={'w-full  max-md:text-start'}> Bular orasida albatta siz ham
