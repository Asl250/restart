...
const Eyes = () => {
	return (
		<div className={'bg-[#141522] my-24 py-14'}>
			...
			<h1 className={'w-full inter text-7xl max-md:text-5xl text-center font-semibold text-green-400'}>“Ko’zlarimga
				Ishonmayman”</h1>
			<h1 className={'w-full inter text-2xl text-center font-semibold text-white mt-4'}>nomli to’lovingizni 100%
			...
			<div className={'mt-14 xl:mx-[7%] max-lg:mx-[5%] text-start grid lg:grid-cols-2'}>
				...
				<div className={'inter space-y-5 py-5'}>
