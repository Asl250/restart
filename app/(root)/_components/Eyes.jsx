	...
	return (
		<div className={'bg-black  py-14'}>
			...
			<h1 className={'w-full font-semibold text-[#feebbd] inter text-7xl max-md:text-5xl text-center'}>“Ko’zlarimga
				Ishonmayman”</h1>
			<h1 className={'w-full inter text-lg text-center text-white mt-4'}>nomli to’lovingizni 100%
			...
			<div className={'mt-14 xl:mx-[7%] max-lg:mx-[5%] text-start grid lg:grid-cols-2'}>
				...
				<div className={'text-lg border border-[#feebbd] rounded-xl p-5 inter space-y-7 py-5'}>
					<p className={'inter w-full text-white'}>Ushbu darslarni yozish uchun ko’plab o’z ishini
						mutaxassilari mehnat qildi</p>
					<p className={'w-full text-white'}>Va bu darslar sizga yoqishiga men kafolat beraman.</p>
					<p className={'w-full text-white'}>Agarda darslarni olib, ko’rib chiqsangiz-u…</p>
					<p className={'w-full text-white'}>Va ushbu darslikdagi ma’lumotlar 497,000 so’mga
						arzishiga ishonch hosil qilmasangiz,</p>
					<p className={' w-full text-white'}>Bizga darsni xarid qilgan sanangizdan boshlab, 3 kun
						ichida murojaat qiling. </p>
					<p className={'w-full  text-white'}>To’lovingizni 100% to’liq holda qaytarib beramiz.</p>
				</div>
