		...
		<div className={'mx-[10%] my-32 inter'}>
			...
			<Accordion type="single" collapsible className="w-full">
				<AccordionItem value="item-1" className={'mb-5 border-[2px] rounded-lg p-3'}>
					<AccordionTrigger className={'text-lg text-start max-md:text-lg max-sm:text-lg'}>497,000 so’mdan necha marta to’laymiz?</AccordionTrigger>
				...
				<AccordionItem value="item-2" className={'mb-5  border-[2px] rounded-lg p-3'}>
					<AccordionTrigger className={'text-lg text-start max-md:text-lg max-sm:text-lg'}>Yangi darsliklar ham qo’shiladimi? </AccordionTrigger>
					<AccordionContent className={'text-lg '}>
				...
				<AccordionItem value="item-3" className={'mb-5 border-[2px] rounded-lg p-3 text-start'}>
					<AccordionTrigger className={'text-lg max-md:text-lg max-sm:text-lg text-start'}>Barcha darslar darhol ochiladimi? </AccordionTrigger>
				...
				<AccordionItem value="item-4" className={'mb-5 border-[2px] rounded-lg p-3'}>
					<AccordionTrigger className={'text-lg max-md:text-lg max-sm:text-lg text-start'}>Bu darsliklardan qanday foyda olaman?</AccordionTrigger>
					<AccordionContent className={'text-lg'}>
