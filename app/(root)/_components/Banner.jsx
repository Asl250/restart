...
const Banner = () => {
	return (
		<div className={'bg-[#E73904] w-full py-16 bg-[url("/banner-bg.jpg")]'}>
			
			<div>
				<div className={'w-full text-center text-white p-3'}>
					<h1 className={'poppins max-md:text-4xl text-8xl font-[91.2px] text-center pb-5'}>UY SOTIB OLISHDA <br/> ALDANIB QOLMANG!</h1>
					...
					<Button className={'mt-24 italic font-bold bg-black hover:bg-black w-[80%] md:w-[40%]  py-16 max-md:py-7  xl:text-4xl lg:text-3xl md:text-2xl max-md:text-xl  uppercase'}>Hoziroq Darslikni olish</Button>
