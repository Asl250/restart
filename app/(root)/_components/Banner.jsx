		...
		<div className={'bg-[#db4034] w-full py-16'}>
			...
			<div>
				<div className={'w-full text-center text-white p-3'}>
					...
					<Button className={'mt-24 italic font-bold bg-gradient-to-tr from-gray-800 to-gray-700 hover:bg-black w-[80%] md:w-[50%]  py-16 max-md:py-7  xl:text-4xl lg:text-3xl md:text-2xl max-md:text-xl  uppercase'}>Hoziroq Darslikni olish</Button>
